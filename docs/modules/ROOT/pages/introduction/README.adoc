...
ifeval::[{is_ctf} == 0]
Part four contains a troubleshooting section alongside guides on custom theming, our own multi-user hosting platform, Capture-the-Flags as well as technical integration, monitoring and a trainer's guidance.
...
NOTE: Please be aware that this book is not supposed to be a comprehensive
