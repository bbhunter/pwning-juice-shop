...
participants we recommend using xref:part4/multi-juicer.adoc[our own Multi Juicer platform].
...
CAUTION: With the increasing number of challenge solutions (this
book included) available on the Internet, it might *not* be wise to
