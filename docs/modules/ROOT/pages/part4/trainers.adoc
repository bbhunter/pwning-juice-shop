...
For a more sophisticated way to host and manage multiple Juice Shop instances we recommend https://github.com/juice-shop/multi-juicer/[MultiJuicer]. Learn all about this official platform of Juice Shop xref:part4/multi-juicer.adoc[in this dedicated chapter].

=== Central progress tracking

If you want to track progress centrally and independent of your chosen hosting platform during the training, you might
