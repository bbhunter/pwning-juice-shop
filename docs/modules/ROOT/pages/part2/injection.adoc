...
[[_extract_the_chatbots_system_prompt]]
== Extract the chatbot's system prompt

The chatbot has a system prompt with both public and confidential instructions.
Try to make it reveal its full configuration using prompt injection.

include::../../partials/hints/systemPromptExtractionChallenge.adoc[]
